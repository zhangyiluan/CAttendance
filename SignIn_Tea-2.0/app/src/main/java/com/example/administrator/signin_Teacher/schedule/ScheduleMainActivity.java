package com.example.administrator.signin_Teacher.schedule;
...
//        getSupportActionBar().hide();
    ...
    private void loadSchedule() {
        ...
        if (!file.exists()) {
            if (!file.mkdirs()) {
                (Toast.makeText(ScheduleMainActivity.this,"建立文件路径错误", Toast.LENGTH_SHORT)).show();
            }
        }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(c.className = className.getText().toString()).equals("")) {
                    ...
                    (Toast.makeText(ScheduleMainActivity.this,"课程不能为空", Toast.LENGTH_SHORT)).show();
                }
