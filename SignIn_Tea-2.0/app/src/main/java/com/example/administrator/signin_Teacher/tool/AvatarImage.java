package com.example.administrator.signin_Teacher.tool;
 ...
 */
public class AvatarImage extends android.support.v7.widget.AppCompatImageView {
    ...
    public AvatarImage(Context context, AttributeSet attrs, int defStyle) {
